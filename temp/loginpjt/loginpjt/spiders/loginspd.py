...
class LoginspdSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        return [Request("https://accounts.douban.com/login", meta={"cookiejar": 1}, headers=self.headers,
                        callback=self.parse)]
    ...
    def parse(self, response):
        ...
        if len(captcha) > 0:
            print("此时有验证码")
            # 设置将验证码图片存储到本地的本地地址
            localpath = r"D:/scrapystudy/data/captcha.png"
            ...
            data = {
                ...
                "form_email": "huoliang722@sina.com",
                # 设置登录密码，格式为密码字段名:具体密码，读者需要将账号密码换成自己的
                # 因为笔者完成该项目后已经修改密码
                "form_password": "H860724l",
                # 设置验证码，格式为验证码字段名:具体验证码
                "captcha-solution": captcha_value,
                # 设置需要转向的网址，由于我们需要爬取个人中心页，所以转向个人中心页
                "redir": "https://www.douban.com/people/56987525/",
            }
